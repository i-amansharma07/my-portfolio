...
//text-light-dim hover:underline hover:text-black  dark:hover:text-white dark:text-dark-dim
const BlogsSection = () => {
  return (
    <FadeInSection>
      <FlexColumn className="mt-5">
        <h1 className="blogs-heading text-lg dark:text-dark-dim">Latest Wanders</h1>
        <div className="flex ">
